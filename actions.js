...
// downloading actions
export const DOWNLOAD_AUDIO_TO_DEVICE = "DOWNLOAD_AUDIO_TO_DEVICE"
export const DOWNLOAD_AUDIO_TO_DEVICE_COMPLETED = "DOWNLOAD_AUDIO_TO_DEVICE_COMPLETED"
export const DOWNLOAD_AUDIO_TO_DEVICE_FAILED = "DOWNLOAD_AUDIO_TO_DEVICE_FAILED"
export const DOWNLOAD_AUDIO_TO_DEVICE_PROGRESS = "DOWNLOAD_AUDIO_TO_DEVICE_PROGRESS"

export const REGISTER_AUDIO_ON_DEVICE = "REGISTER_AUDIO_ON_DEVICE" // put the entry from async storage to the store
...
export const SET_PLAYING_AUDIO_INFO = "SET_PLAYING_AUDIO_INFO"
